...
(function () {
    ...
    function onDeviceReady() {
        ...
        var myAjaxCall = $.getJSON('http://www.pallavoloc9.it/php/eventi-json.php', function (data) {
                ...
                for (var j in data.news) {
                    ...
                    num = num + 1;
                            ...
                            var dataevento = object.data;
                            var luogo = object.luogo;
                            var concluso = object.concluso;
                            
                            output += "<li style='text-align:justify;padding-top:1em'><center><span style='color:#cc0000'>" + concluso + "</span></center><span style='text-align:right;padding:0;margin:0;'>" + dataevento + "</span>";
                            output += "<h4 style='padding-top:1em;font-weight: bold;'><center><b>" + titolo.toUpperCase() + "</b></center></h4>";
                            output += testo;
                            output += "<br /><br /><div style='font-style:italic'>" + luogo + "</div>";
                            output += "</li>";
                }
                output += "</ul></div>";
                document.getElementById("eventi").innerHTML = output;
